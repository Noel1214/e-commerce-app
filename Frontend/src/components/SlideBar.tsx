...
const SlideBar = () => {
    ...
    return (
        <div id='parent-nav' className={`bg-black text-white h-[100vh] w-[5rem] hover:w-[19rem] transition-all duration-500 ease-in-out hover:shadow-slate-700 shadow-2xl font-semibold text-lg`} onMouseLeave={() => onMouseHoverHandler(false)} onMouseEnter={() => onMouseHoverHandler(true)}>
            <nav className=''>
                <ul className='flex flex-col justify-center gap-14 absolute top-12 left-7'>
                    <li className='flex gap-5 h-[2rem] hover:scale-125 transition-all duration-300 ease-in-out'>
                    ...
                    <Link href="/cart">
                        <div className='flex gap-5 hover:scale-125 transition-all duration-300 ease-in-out'>
                    ...
                    <li className='flex gap-5 hover:scale-125 transition-all duration-300 ease-in-out'>
                        <MdFavoriteBorder size={26} />
                        <h1 className={`${isMouseHovering ? 'opacity-1 transition-all duration-500 ease-in' : 'opacity-0'} translate-y-1`}>Favorites</h1>
                    </li>
                    <li className='flex gap-5 hover:scale-125 transition-all duration-300 ease-in-out relative top-[12rem]'>
                        <CiUser size={26} />
